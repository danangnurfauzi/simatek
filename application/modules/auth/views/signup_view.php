...
<body id="signup-page">
<div class="page-form">
    <form id="signup-form" action="<?php echo site_url('auth/signup/register') ?>" method="post" class="form">
        <div class="header-content"><h1>Daftar</h1></div>
        <div class="body-content">
            ...
            <div class="form-group">
                <div class="input-icon right"><i class="fa fa-user"></i><input type="text" placeholder="NPK" name="npk" class="form-control"></div>
            </div>
            <!--div class="form-group">
            ...
            <hr>
            <div class="form-group mbn"><a href="<?php echo site_url('auth/login') ?>" class="btn btn-warning"><i class="fa fa-chevron-circle-left"></i>&nbsp;
                Back</a>
