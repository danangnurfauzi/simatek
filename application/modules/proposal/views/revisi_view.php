                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body pan">
                                <form action="<?php echo site_url('proposal/pengajuan/updateRevisi/'.$proposal->p_id.'/'.$proposal->p_tp_id) ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-body pal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="jenisKegiatan" class="form-control">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $row->jk_id?>" <?php echo ($row->jk_id == $proposal->p_jk_id) ? "selected='selected'" : "" ?> ><?php echo $row->jk_nama ?></option>
                                                    <?php
                                                            }
                                                    }
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Judul Kegiatan<span class="require">*</span></label>
                                            <div class="col-md-9">
                                                <input name="nama" placeholder="" class="form-control" type="text" value="<?php echo $proposal->p_kegiatan ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group mbn"><label for="inputContent" class="col-md-3 control-label">Latar Belakang<span class="require">*</span></label>
                                        ...
                                        <br/>
                                        <div class="form-group mbn"><label for="inputContent" class="col-md-3 control-label">Tujuan<span class="require">*</span></label>
                                        ...
                                        <br/>
                                        <div class="form-group mbn"><label for="inputContent" class="col-md-3 control-label">Luaran<span class="require">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail" class="col-md-3 control-label">Waktu<span class="require">*</span></label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Pihak Luar Yang Terlibat<span class="require">*</span></label>
                                            <div class="col-md-9">
                                        ...
                                        <div id="formPihakLuar" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input name="nomorPihakLuar" placeholder="Nomor Telp" class="form-control" type="text" id="nomorPihakLuar" value="<?php echo $proposal->p_pihak_luar_nama ?>">
                                                </div>
                                                <div class="col-md-3">
                                                    <input name="organisasiPihakLuar" placeholder="Nama Organisasi/Instansi" class="form-control" type="text" id="organisasiPihakLuar" value="<?php echo $proposal->p_pihak_luar_telephone ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group"><label for="inputAddress" class="col-md-3 control-label">Total Anggaran<span class="require">*</span></label>
                                            <div class="col-md-9">
                                                </i><input name="biaya" placeholder="" class="form-control" type="number" value="<?php echo $proposal->p_biaya ?>">
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="form-group">
                                            <label for="exampleInputFile" class="col-md-3 control-label">File<span class="require">*</span></label>
                                            <div class="col-md-1">
                                    ...
                                    <div class="form-actions">
                                        <div class="col-md-offset-3 col-md-9">
                                            <input type="submit" class="btn btn-primary" name="submit" value="Revisi">
                                            &nbsp;
