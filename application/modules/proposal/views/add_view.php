                                ...
                                <form action="<?php echo site_url('proposal/pengajuan/insert') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-body pal">
                                        ...
                                        <div class="form-group"><label for="inputAddress" class="col-md-3 control-label">Total Anggaran<span class="require">*</span></label>
                                            <div class="col-md-9">
                                                </i><input name="biaya" placeholder="" class="form-control" type="number">
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="form-group"><label for="exampleInputFile" class="col-md-3 control-label">File<span class="require">*</span></label>
