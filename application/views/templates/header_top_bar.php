    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" data-intro="&lt;b&gt;Topbar&lt;/b&gt; has other styles with live demo. Go to &lt;b&gt;Layouts-&gt;Header&amp;Topbar&lt;/b&gt; and check it out." class="navbar navbar-default navbar-static-top">
            <div class="navbar-header">
                ...
                <a id="logo" href="<?php echo site_url('home/dashboard') ?>" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">SIMATEK</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><?php echo ( $foto != null) ? '<img src="'.base_url().$foto.'" alt="" class="img-responsive img-circle"/>' : '<img src="https://s3.amazonaws.com/uifaces/faces/twitter/kolage/48.jpg" alt="" class="img-responsive img-circle"/>' ?>&nbsp;<span class="hidden-xs"><?php echo $_SESSION['username'] ?></span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li><a href="<?php echo site_url('user/user/profiles') ?>"><i class="fa fa-user"></i>My Profile</a></li>
