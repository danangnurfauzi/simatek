<!--BEGIN FOOTER-->
            <div id="footer">
                <div class="copyright">2016 © LKM - UMY</div>
            </div>
            <!--END FOOTER--></div>
...
<script src="<?php echo base_url() ?>assets/vendors/uploadify/jquery.uploadify.min.js"></script>
...
<script src="<?php echo base_url() ?>assets/js/autoresize-textarea.js"></script>